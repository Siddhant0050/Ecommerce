            ...
            <div id="content">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/20084000/2022/9/20/809b3a06-2af4-455c-95e5-b679f88ca2c61663654304864MactreeMenWhiteColourblockedPUSneakers1.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Mactree Casual Shoes</h5>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/23869882/2023/7/4/bf58b931-1da6-467b-a3e5-133d1118dbcd1688469529787RedTapeMenWhiteWovenDesignSneakers1.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Men Footwear - Buy Footwear</h5>
                                <p class="card-text">₹ 1400</p>
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                                    <a href="#!" class="btn btn-light border px-2 pt-2 icon-hover"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/18274390/2022/5/14/c64644f6-840f-4496-bb42-19359e9881771652523841987RoadsterMenBrownTexturedPUSneakers1.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Men Footwear Brown Sneakers</h5>
                                <p class="card-text">₹ 1400</p>
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                                    <a href="#!" class="btn btn-light border px-2 pt-2 icon-hover"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/20026178/2022/9/17/95b7750e-7455-4fd1-bb44-bf064f1acb501663415343260CasualShoes1.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Buy White Casual Shoes for Men</h5>
                                <p class="card-text">₹ 1400</p>
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                                    <a href="#!" class="btn btn-light border px-2 pt-2 icon-hover"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/14769850/2022/4/26/21ae91bc-b379-4848-bd84-17b234dc083b1650947244961-Roadster-Men-Beige--Green-Colourblocked-Sneakers-81116509472-7.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Roadster Shoes - Buy Roadster</h5>
                                <p class="card-text">₹ 1400</p>
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                                    <a href="#!" class="btn btn-light border px-2 pt-2 icon-hover"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/h_1440,q_100,w_1080/v1/assets/images/19781662/2022/9/3/c94927e0-c9a5-40f5-8215-3b5505062fbf1662185000392RedTapeMenBlackMeshRunningNon-MarkingShoes1.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Red Tape Men Black Mesh Running Shoes</h5>
                                <p class="card-text">₹ 1400</p>
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                                    <a href="#!" class="btn btn-light border px-2 pt-2 icon-hover"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/23837948/2023/7/1/d85bb274-a6df-4bee-875d-7dfc98a986581688199092946RedTapeMenBlackColourblockedSneakers1.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Buy Red Tape Shoes</h5>
                                <p class="card-text">₹ 1400</p>
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                                    <a href="#!" class="btn btn-light border px-2 pt-2 icon-hover"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/23393230/2023/5/26/924ec128-ff30-4af1-9560-7ec78e21828b1685073693603RoadsterLatestWomenCasualRunningWalkingSneakers-Tan1.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Casual Shoes for Women</h5>
                                <p class="card-text">₹ 1400</p>
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                                    <a href="#!" class="btn btn-light border px-2 pt-2 icon-hover"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/17755112/2022/4/4/3e291b2e-2e6a-4699-9f42-ea6d8d9512eb1649088875683ASIANMenWhiteSportsShoes1.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Buy Asian Sports Shoes</h5>
                                <p class="card-text">₹ 1400</p>
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                                    <a href="#!" class="btn btn-light border px-2 pt-2 icon-hover"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/18473784/2022/5/27/1096cec5-5cdf-4f1e-bb99-1e23cc73c8c31653657571839RedTapeWomenWhiteSportsShoes1.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Women Shoes - Buy Shoes</h5>
                                <p class="card-text">₹ 1400</p>
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                                    <a href="#!" class="btn btn-light border px-2 pt-2 icon-hover"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/24343602/2023/8/4/d9695e28-9a26-4137-9e05-b89a5f6cb3221691152976080ASIANMenWhiteColourblockedSneakers1.jpg" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title">Shop The Best Casual Shoes</h5>
                                <p class="card-text">₹ 1400</p>
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="#!" class="btn btn-primary shadow-0 me-1">Add to cart</a>
                                    <a href="#!" class="btn btn-light border px-2 pt-2 icon-hover"><i class="fas fa-heart fa-lg text-secondary px-1"></i></a>
